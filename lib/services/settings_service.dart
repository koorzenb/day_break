...
class SettingsService extends GetxService {
  ...
  Future<void> setRecurrencePattern(RecurrencePattern pattern) => _settingsBox!.put('recurrencePattern', pattern.index);
  ...
  Future<void> setRecurrenceDays(List<int> days) => _settingsBox!.put('recurrenceDays', days);
